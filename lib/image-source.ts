...
export interface PHPDockerImageSourceConfig {
 ...
 */
export interface PHPDockerImageSourceContext {
    /**
...
class PHPDockerAssetDirectorySource extends PHPDockerImageSource {
    ...
    public bind(scope: Construct, context: PHPDockerImageSourceContext): PHPDockerImageSourceConfig {
